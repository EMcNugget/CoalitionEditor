...
export default defineComponent({
  setup() {
    ...
    const neutralOptions: Option[] = [];
    const source = ref<Option[]>(transferOptions);
    const target = ref<Option[]>(targetOptions);
    const neutral = ref<Option[]>(neutralOptions);
